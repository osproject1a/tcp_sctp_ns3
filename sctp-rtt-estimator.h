 ...
 */
class Sctp_RttEstimator : public Object {
public:
  static TypeId GetTypeId (void);

  Sctp_RttEstimator();
  Sctp_RttEstimator (const Sctp_RttEstimator&); 

  virtual ~Sctp_RttEstimator();
  ...
  virtual Ptr<Sctp_RttEstimator> Copy () const = 0;
 ...
 *
 */
class RttMeanDeviation : public Sctp_RttEstimator {
public:
  static TypeId GetTypeId (void);
  ...
  Ptr<Sctp_RttEstimator> Copy () const;
