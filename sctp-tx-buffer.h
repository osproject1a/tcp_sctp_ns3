...
#ifndef SCTP_TX_BUFFER_H
#define SCTP_TX_BUFFER_H
 ...
 * \ingroup sctp
 *
 * \brief class for keeping the data sent by the application to the SCTP socket, i.e.
 *        the sending buffer.
 */
class SctpTxBuffer : public Object
{
public:
  static TypeId GetTypeId (void);
  SctpTxBuffer (uint32_t n = 0);
  virtual ~SctpTxBuffer (void);
