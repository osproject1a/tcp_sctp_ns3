...
#ifndef SCTP_RX_BUFFER_H
#define SCTP_RX_BUFFER_H
 ...
 *        SctpL4Protocol, sent to the application
 */
class SctpRxBuffer : public Object
{
public:
  static TypeId GetTypeId (void);
  SctpRxBuffer (uint32_t n = 0);
  virtual ~SctpRxBuffer ();
   ...
   */
  bool Add (Ptr<Packet> p, SctpHeader const& sctph);
